...
print('='*40)
print(lanche[0])   #mostra o elemento na posição 0
print(lanche[1])   #mostra o elemento na posição 2
print(lanche[2])   #mostra o elemento na posição 2
print(lanche[3])   #mostra o elemento na posição 3
print(lanche[-1])  #mostra o elemento na posição -1(último)
print(lanche[-2])  #mostra o elemento na posição -2(penúltimo)
print(lanche[-3])  #mostra o elemento na posição -3(antepenúltimo)
print(lanche[-4])  #mostra o elemento na posição -4(anterior ao antepenúltimo)
print(lanche[1:3]) #mostra o elemento na posição 1 e 2(o 3 não entra)
print(lanche[2:])  #mostra o elemento da posição 2 aé o final
print(lanche[:2])  #mostra o elemento na posição 0 e 1(o 2 não entra)
print(lanche[-2:]) #mostra o elemento na posição -2 até o final
print('='*40)
a = 2, 5, 4
b = 5, 8, 1, 2
